...
##* Clustering the points of a certain frame of a given trajectory directory
##* Using the method of DBSCAN
##* Output a picture containing ALL clusters of a CERTAIN frame from a CERTAIN trajectory
...
for label in label_set:
    ...
    ###* Use DBSCAN to fit the inserted cluster *###
